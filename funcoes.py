...
def classificacaoEletromag():
    ...
    print("Visível (Violeta) -> 400 [nm] <= (λfóton) < 434,1 [nm]")
    print("Visível (Azul) -> 434,1 [nm] <= (λfóton) < 486,1 [nm]")
    print("Visível (Verde) -> 486,1 [nm] <= (λfóton) < 656,3 [nm]")
    print("Visível (Vermelho) -> 656,3 [nm] <= (λfóton) < 700 [nm]")
...
def transicoesHidrogenio():
    ...
    print()
    print("Se a energia do foton > 13.6 [eV]: ")
    print("Sim, mas o átomo seria ionizado.")
    print()
    print("Se a energia do foton < 10.2 [eV] ")
    print("Não é possível excitar o elétron do estado fundamental.")
