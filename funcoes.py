...
def classificacaoEletromag():
    ...
    print("Visível (Violeta) -> 400 [nm] <= (λfóton) < 450 [nm]")
    print("Visível (Azul) -> 450 [nm] <= (λfóton) < 495 [nm]")
    print("Visível (Verde) -> 495 [nm] <= (λfóton) < 570 [nm]")
    print("Visível (Amarelo) -> 570 [nm] <= (λfóton) < 590 [nm]")
    print("Visível (Laranja) -> 590 [nm] <= (λfóton) < 620 [nm]")
    print("Visível (Vermelho) -> 620 [nm] <= (λfóton) < 700 [nm]")
